...
analytics_report.txt: Contains the final analytical results (Q1, Q2, Q3).

quarantined_events.csv: A log file containing all source rows that failed the ETL's data quality checks. 
